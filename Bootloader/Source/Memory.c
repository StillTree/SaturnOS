...
inline UINT16 VirtualAddressPageOffset(EFI_VIRTUAL_ADDRESS address) { return address & VIRTUAL_ADDRESS_PAGE_OFFSET_MASK; }

inline UINT16 VirtualAddressP1Index(EFI_VIRTUAL_ADDRESS address) { return (address >> 12) & VIRTUAL_ADDRESS_ENTRY_INDEX_MASK; }

inline UINT16 VirtualAddressP2Index(EFI_VIRTUAL_ADDRESS address) { return (address >> 21) & VIRTUAL_ADDRESS_ENTRY_INDEX_MASK; }

inline UINT16 VirtualAddressP3Index(EFI_VIRTUAL_ADDRESS address) { return (address >> 30) & VIRTUAL_ADDRESS_ENTRY_INDEX_MASK; }

inline UINT16 VirtualAddressP4Index(EFI_VIRTUAL_ADDRESS address) { return (address >> 39) & VIRTUAL_ADDRESS_ENTRY_INDEX_MASK; }
...
inline UINT64 PageTableEntry(EFI_PHYSICAL_ADDRESS address, UINT16 flags) { return address | flags; }

...
Result CPUIDSaveInfo(CPUInfo* cpuInfo)
{
	...
	if (!result) {
		cpuInfo->SupportsAVX = (featuresInfo.ECX >> 28) != 0;
		cpuInfo->SupportsMMX = (featuresInfo.EDX >> 23) != 0;
		cpuInfo->SupportsSSE = (featuresInfo.EDX >> 25) != 0;
		cpuInfo->SupportsSSE2 = (featuresInfo.EDX >> 26) != 0;
		cpuInfo->SupportsXAPIC = (featuresInfo.EDX >> 9) != 0;
		cpuInfo->SupportsX2APIC = (featuresInfo.ECX >> 21) != 0;
	}
